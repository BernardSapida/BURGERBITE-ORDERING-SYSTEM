...
<head>
    ...
    <link rel="icon" type="image/any-icon" href="images/burgerbites.ico">
  	<meta property="og:title" content="BurgerBites Restaurant | About Us">
    <meta property="og:url" content="https://BurgerBites.x10.mx/about.php">
...
<body>
    ...
    <main>
        ...
        <section class="section_mvv">
            ...
            <div class="container_mission">
                <div class="container_mission-image">
                    <img src="images/about/about-mission.jpg" alt="BurgerBites Mission Image">
                </div>
            ...
            <div class="container_vision">
                <div class="container_vision-image">
                    <img src="images/about/about-vision.jpg" alt="BurgerBites Vision Image">
                </div>
        ...
        <section class="section_products-services">
            ...
            <div class="container_restaurant-delivery">
                <div class="container_restaurant-delivery-image">
                    <img src="images/about/about-restaurant.jpg" alt="BurgerBites Restaurant Delivery Image">
                </div>
            ...
            <div class="container_quality-service">
                <div class="container_quality-service-image">
                    <img src="images/about/about-quality.jpg" alt="BurgerBites Quality Service Image">
                </div>
        ...
        <!-- BurgerBites Members Contribution-->
