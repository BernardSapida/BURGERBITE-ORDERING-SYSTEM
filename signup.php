...
<head>
    ...
    <meta name="author" content="BERNARD V. SAPIDA, JAN MARICHIE Z. MOJICA, ZILDJIAN LEE G. LOREN, JOHN HERSON L. RADONES">
  	...
  	<meta property="og:title" content="BurgerBites Restaurant | Sign Up">
    <meta property="og:url" content="https://BurgerBites.x10.mx/signup.php">
        ...
        <section class="section_signup">
            <div class="container_signup">
                <div class="container_title">
                    <h1>Sign Up to BurgerBites</h1>
                    <p>Create your BurgerBites account</p>
                </div>
