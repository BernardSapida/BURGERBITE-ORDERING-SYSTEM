            ...
            if(filter_var($email, FILTER_VALIDATE_EMAIL)) {
                ...
                if(is_array($row_result)) {
                    ...
                    try {
                        ...
                        //                             <p class="email_header-logo"><img src="https://i.ibb.co/dcBt23r/279377135-1117847642111961-6949520978733401421-n.png" alt="BurgerBites Logo" style="display: block; margin: auto; width: 100%;  max-width: 120px;"></p>
                        //                         </div>
                        ...
                        //                             <p class="email-copyright" style="text-align: center; margin: 10px; font-size: 12px; color: hsl(0, 0%, 100%, .5); font-weight: 300;">Copyright &copy;2022 BurgerBites. All Rights Reserved.</p>
                        //                         </div>
                        //                     </section>';
...
<head>
    ...
    <meta name="author" content="BERNARD V. SAPIDA, JAN MARICHIE Z. MOJICA, ZILDJIAN LEE G. LOREN, JOHN HERSON L. RADONES">
  	...
  	<meta property="og:title" content="BurgerBites Restaurant | Reset Password">
    <meta property="og:url" content="https://BurgerBites.x10.mx/forgot-password.php">
...
<body>
    ...
    <!-- BurgerBites Forgot Password Page -->
    <main>
