<?php
    ...
    $connect = mysqli_connect("localhost", "yoyiqlnx_burgerbites", "@Burgerbites1708131117", "yoyiqlnx_burgerbites");
...
<head>
    ...
    <meta name="author" content="BERNARD V. SAPIDA, JAN MARICHIE Z. MOJICA, ZILDJIAN LEE G. LOREN, JOHN HERSON L. RADONES">
  	...
  	<meta property="og:title" content="BurgerBites Restaurant | Admin">
    <meta property="og:url" content="https://BurgerBites.x10.mx/admin_accounts.php">
